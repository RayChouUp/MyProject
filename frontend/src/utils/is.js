...
//判断对象数组的某个属性是否全等
export const isPropEqual = (array, propertyName) => {
  if (!Array.isArray(array) || typeof propertyName !== "string") {
    return false;
  }
  ...
  return array.every(item => item[propertyName] == array[0][propertyName]);
};
